...
import { useGLTF, useTexture, useCursor, useAnimations, useFBX } from "@react-three/drei"
...
export default function Model({ pose, ...props }) {
  ...
  const { scene, animations } = useFBX("./GmCafe/HolloHoodie_Idle.fbx")
  const texture = useTexture("./GmCafe/Clothes&Hair.jpg")
